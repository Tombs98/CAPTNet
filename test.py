...
from naf import NAFNetLocal
from skimage import img_as_ubyte
from pdb import set_trace as stx
from newfor import CATNetLocal

parser = argparse.ArgumentParser(description='Image Deblurring using MPRNet')

parser.add_argument('--input_dir', default='./Datasets/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./newfo_v/newfo_n', type=str, help='Directory for results')
parser.add_argument('--weights', default='./newfo_C_new/model_best.pth', type=str, help='Path to weights')

...
from newfor import CATNet


dir_checkpoint = Path('./newfo_64_n/')
...
if opt.TRAINING.RESUME:
    path_chk_rest    = './newfo_64_n/model_best.pth'
...
val_loader = DataLoader(dataset=val_dataset, batch_size=opt.OPTIM.BATCH_SIZE, shuffle=False, num_workers=16, drop_last=False, pin_memory=True)
    ...
    if epoch % opt.TRAINING.VAL_AFTER_EVERY == 0:
        ...
        for ii, data_val in enumerate((val_loader), 0):
            ...
            for res, tar in zip(restored, target):
                ...
                # psnr_11, ssim_11 = coun(res, target)
                # psnr_te_1 = psnr_te_1+psnr_11
                # ssim_te_1 = ssim_11+ssim_te_1
